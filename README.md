...
> **Note:** the port names in the example (`n6080`, `n6081`) correspond to
> services you may have configured.  If you try to open `http://localhost:6080`
> in your browser without creating a service bound to that port you'll get a
> "404 – File not found" page (see screenshot).  only the ports you actually
> configure will serve a noVNC client – the default proxy listens on *6081*
> when using the command examples earlier.
